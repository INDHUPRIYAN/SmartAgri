...
export default function SoilHealth() {
  ...
  useEffect(() => {
    ...
    const lon = 76.9;
    const depth = "15-30cm";
    const url = `${BACKEND_BASE}/soil/point?lat=${lat}&lon=${lon}&depth=${encodeURIComponent(depth)}`;
  ...
  const { location, depth: soilDepth, soil_summary } = data;
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.sub}>Depth: {soilDepth}</Text>
